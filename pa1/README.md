To run this program, include files List.h, List.c, ListTest.c, Lex.c, and Makefile in the same directory. Running Lex.c uses the format ./Lex <input file> <output file>.
